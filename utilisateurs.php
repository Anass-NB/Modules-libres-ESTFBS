          ...
          <div class="col-md">
            ...
            <div class="panel panel-default">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href='edit.php?edit=user&id=<?php echo $utilisateur["id_utilisateur"] ?>' class='btn btn-sm btn-warning'>Modifier</a>
              ...
              if (isset($_POST["delete_user"])) {
                ...
                $row = $query->bindParam(":id", $_POST["id_utilisateur"], PDO::PARAM_INT);
                $query->execute();
